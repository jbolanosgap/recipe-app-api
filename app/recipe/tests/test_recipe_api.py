...
def detail_url(recipe_id):
    """Create and return the url to get details about specific recipe"""
...
class PublicRecipeApiTests(TestCase):
    """Test the unauthenticated recipe API requests"""
...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        create_recipe(user=self.user, title='Sample Recipe 3')
    ...
    def test_create_recipe(self):
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('5.00'),
            'description': 'Chocolate recipe',
            'link': 'https://example.com/chocolate.pdf',
        }
